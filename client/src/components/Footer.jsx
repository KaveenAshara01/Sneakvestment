    ...
    return (
        <footer className="py-12 px-6 bg-white text-center border-t border-gray-100 mt-auto">
            <div className="container-custom">
                <img src="/logo.png" alt="Sneakvestment" className="h-10 w-auto mx-auto mb-6 opacity-100 grayscale" />
                ...
                <div className="flex justify-center gap-6 mb-6">
                    <a href="https://wa.me/447445770942" target="_blank" rel="noreferrer" className="text-gray-400 hover:text-[#25D366] transition-colors text-2xl">
                        <FaWhatsapp />
                    </a>
