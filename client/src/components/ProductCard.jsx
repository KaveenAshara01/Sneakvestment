    ...
    return (
        <div className="group bg-white border border-secondary hover:border-primary hover:-translate-y-1 hover:shadow-[0_10px_40px_-10px_rgba(59,130,246,0.2)] transition-all duration-300">
            ...
            <div className="p-4 border-t border-secondary">
                ...
                <h3 className="text-lg font-bold text-gray-900 mb-2 truncate font-heading">{product.name}</h3>
                ...
                <Link to="/inquiry" className="block w-full text-center border border-gray-900 text-gray-900 font-bold py-2 uppercase text-sm hover:bg-primary hover:text-white hover:border-primary hover:shadow-[2px_2px_0px_#000] transition-all">
                    Inquire
                </Link>
            </div>
        </div>
